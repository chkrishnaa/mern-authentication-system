    ...
    <div className="grid sm:grid-cols-4 h-screen overflow-hidden">
      ...
      >
        ...
        {/* <form className="md:w-96 w-80 flex flex-col items-center justify-center space-y-4">
          ...
          <div className="flex flex-col justify-center items-center">
            <p className="text-sm text-gray-500/90">
              Enter a 6-digit reset password code sent to your email.
            </p>
            <p className="text-sm text-red-500/90">OTP valid for 10 minutes.</p>
          </div>

          <div className="flex justify-between w-full">
            <div className="flex items-center h-12 w-12 rounded-lg border border-gray-300/60 bg-white px-4 gap-3">
              <input
                type="text"
                className="flex-1 bg-transparent text-gray-600 placeholder-gray-400 outline-none text-sm"
                required
