...
const Hero = () => {
  return (
    <section className="min-h-screen flex items-center justify-center max-w-6xl mx-auto px-4">
      {/* Glass Card */}
      <div className="relative max-w-3xl w-full rounded-xl overflow-hidden h-100">
        ...
        <div className="relative z-10 text-center py-8 px-8">
          ...
          <h className="text-2xl md:text-3xl font-bold text-cyan-300">
            Welcome to our App !!!!
          </h>
          ...
          <button className="bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-600 hover:to-blue-600 px-8 py-2 rounded-full mt-8 text-white">Get Strated</button>
        </div>
      </div>
    </section>
  );
